...
#define WIFI_STATIC_IP_LOCAL  192,168,1,165
#define WIFI_STATIC_IP_GW     192,168,1,1
#define WIFI_STATIC_IP_SUBNET 255,255,255,0
#define WIFI_STATIC_IP_DNS1   8,8,8,8
#define WIFI_STATIC_IP_DNS2   8,8,4,4

#define WIFI_STA_SSID   "wifi name"      // WiFi SSID      (leave empty ("") to not use WiFi)
#define WIFI_STA_PSK    "wifi password"  // WiFi password  (leave empty ("") to not use WiFi)
